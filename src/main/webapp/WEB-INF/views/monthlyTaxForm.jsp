...
<body>
	...
	<div align="center">
		...
		<form:form action="updateMonthlyTax" method="post"
			modelAttribute="monthlyTax">
			<table>
				<form:hidden path="monthlyTaxId" />
				<tr>
					<td>Tháng:</td>
					<td><form:select class="userInput" path="time"
							required="required" style="font-size: 1vw; height: 4vh;">
				...
				<tr>
					...
					<td><form:radiobutton path="status" value="true"
							required="required" /> Đã Thanh Toán <br> <form:radiobutton
							path="status" value="false" required="required" /> Chưa Thanh
						Toán</td>
				</tr>
				<tr>
					<td>Mã Thuế:</td>
